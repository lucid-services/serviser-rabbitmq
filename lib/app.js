...
App.prototype.$init = function() {
    ...
    this.once('init', function() {
        this.on('error-response', function(err, res) {
...
App.prototype.$build = function() {
    ...
    process.nextTick(function() {
        ...
        app.context.once('ready', function(channel) {
            app.routers.forEach(function(router) {
                router.routes.forEach(function(route) {
                    let cb = route.build();
                    let socket = app.context.socket(route.options.type);
...
App.prototype.listen = function() {
    ...
    this.context = rabbit.createContext(this.$getBrokerURI());
    this.$build();
    ...
    this.context.once('ready', function(con) {
